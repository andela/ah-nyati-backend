const mailTemplate = (username, activateToken) => {
  const template = `
...
<p style="font-size: 14px; line-height: 33px; text-align: center; margin: 0;"><span style="font-size: 28px;"><strong><span style="line-height: 33px; font-size: 28px;">Hello ${username},</span></strong></span><br/><span style="font-size: 28px; line-height: 33px;">Registration completed</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<div style="color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
<div style="font-size: 12px; line-height: 18px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; color: #555555;">
<p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0;">Thanks so much for joining Our Site!</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0;">TO FINISH SIGNING UP AND ACTIVATE YOUR ACCOUNT<br/>YOU JUST NEED TO VERIFY YOUR EMAIL</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<a href="${activateToken}" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#2E99D6;border-radius:4px;-webkit-border-radius:4px;-moz-border-radius:4px;width:auto; width:auto;;border-top:1px solid #2E99D6;border-right:1px solid #2E99D6;border-bottom:1px solid #2E99D6;border-left:1px solid #2E99D6;padding-top:15px;padding-bottom:15px;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:15px;padding-right:15px;font-size:16px;display:inline-block;"><span style="font-size: 16px; line-height: 32px;">ACTIVATE MY ACCOUNT</span></span></a>
