...
<p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0;">TO VERIFY YOUR ACCOUNT<br/>CLICK THE BUTTON BELOW</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<a href="${url}" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#2E99D6;border-radius:4px;-webkit-border-radius:4px;-moz-border-radius:4px;width:auto; width:auto;;border-top:1px solid #2E99D6;border-right:1px solid #2E99D6;border-bottom:1px solid #2E99D6;border-left:1px solid #2E99D6;padding-top:15px;padding-bottom:15px;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:15px;padding-right:15px;font-size:16px;display:inline-block;"><span style="font-size: 16px; line-height: 32px;">VERIFY YOUR ACCOUNT</span></span></a>
